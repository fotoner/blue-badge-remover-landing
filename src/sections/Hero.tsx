    ...
    <section className="relative min-h-[calc(100vh-3.5rem)] border-b border-border px-4 py-24 flex items-center overflow-hidden">
      ...
      <div className="relative mx-auto flex max-w-5xl flex-col items-center gap-12 lg:flex-row lg:gap-16">
        ...
        <div className="flex-1">
          ...
          <div className="mt-10 flex flex-col items-stretch gap-3 sm:flex-row sm:items-start">
            <Button href={CHROME_STORE_URL} onClick={handleCtaClick} className="flex-1 sm:flex-initial sm:min-w-[160px]">
              {t("hero.cta")}
            </Button>
            <Button variant="secondary" href={GITHUB_URL} className="flex-1 sm:flex-initial sm:min-w-[160px]">
